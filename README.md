# Homebrew Tap for PicoRDM

This is the Homebrew tap for [PicoRDM](https://github.com/osdodo/picordm), a lightweight Redis terminal management tool.
...
PicoRDM is a lightweight Redis terminal management tool built with Rust and Ratatui.
